...
public class Level {
    ...
    public Level(TextureAtlas atlas) {
        ...
        tiles.put(TileType.COIN, new Tile(atlas.cut(24 * TILE_SCALE, 1 * TILE_SCALE, TILE_SCALE,
        ...
        tiles.put(TileType.PLATFORM_GRASS_LEFT, new Tile(atlas.cut(5 * TILE_SCALE, 8 * TILE_SCALE, TILE_SCALE,
                TILE_SCALE ), TILE_IN_GAME_SCALE, TileType.PLATFORM_GRASS_LEFT));
        tiles.put(TileType.PLATFORM_GRASS_CENTER, new Tile(atlas.cut(6 * TILE_SCALE, 8 * TILE_SCALE, TILE_SCALE,
                TILE_SCALE ), TILE_IN_GAME_SCALE, TileType.PLATFORM_GRASS_CENTER));
        tiles.put(TileType.PLATFORM_GRASS_RIGHT, new Tile(atlas.cut(7 * TILE_SCALE, 8 * TILE_SCALE, TILE_SCALE,
